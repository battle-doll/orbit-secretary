...
| Платформа | Текущее состояние проверки |
|---|---|
| macOS | Среда локальной проверки; фактически выполненные сценарии перечислены в журнале проверки. |
| Windows | Проверка в CI запланирована; выполнение в Windows ещё не проверено. |
| Linux | Проверка в CI запланирована; выполнение в Linux ещё не проверено. |

Это **не означает прохождения сквозных тестов работы с несколькими задачами во всех трёх ОС**. См. [журнал проверки](docs/VALIDATION.md).
